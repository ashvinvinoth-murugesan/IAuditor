...
public class Page_G extends AppCompatActivity implements BaseSliderView.OnSliderClickListener , View.OnClickListener{
    ...
    String[] section_1={"h","i","j","k","l","m","n","o"};
    ...
    TextView img_toast1,img_toast2;

    RadioGroup rd_main,rd1,rd2,rd3,rd4,rd5,rd6;

    String get_rd_main="",get_rd1="",get_rd2="",get_rd3="",get_rd4="",get_rd5="",get_rd6="";
    ...
    LinearLayout lay_g_1,lay_g_2,lay_g_3,lay_g_4,lay_g_5,lay_g_6;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.page_g);

        db = new DatabaseHelper(Page_G.this);
        ...
        lay_g_1 = (LinearLayout) findViewById(R.id.lay_g_1);
        lay_g_2 = (LinearLayout) findViewById(R.id.lay_g_2);
        lay_g_3 = (LinearLayout) findViewById(R.id.lay_g_3);
        lay_g_4 = (LinearLayout) findViewById(R.id.lay_g_4);
        lay_g_5 = (LinearLayout) findViewById(R.id.lay_g_5);
        lay_g_6 = (LinearLayout) findViewById(R.id.lay_g_6);


        lay_g_1.setVisibility(View.GONE);
        lay_g_2.setVisibility(View.GONE);
        lay_g_3.setVisibility(View.GONE);
        lay_g_4.setVisibility(View.GONE);
        lay_g_5.setVisibility(View.GONE);
        lay_g_6.setVisibility(View.GONE);
...
//                int selectedId=rd1.getCheckedRadioButtonId();
                ...
                if (get_rd_main.equalsIgnoreCase("Yes")) {
                    ...
                    lay_g_1.setVisibility(View.VISIBLE);
                    lay_g_2.setVisibility(View.VISIBLE);
                    lay_g_3.setVisibility(View.VISIBLE);
                    lay_g_4.setVisibility(View.VISIBLE);
                    lay_g_5.setVisibility(View.VISIBLE);
                    lay_g_6.setVisibility(View.VISIBLE);
        ...
        pd = new SpotsDialog(Page_G.this, R.style.Custom);
        ...
        isInternetPresent = haveNetworkConnection(Page_G.this);
            ...
            public void onClick(View v) {
                ...
                if (isInternetPresent) {
                    ...
                    if (validation()) {
                        ...
                        Toast.makeText(Page_G.this, "Please Fill All Details", Toast.LENGTH_SHORT).show();
                    }

                }
                else{
                    pd.dismiss();
                    final Dialog dialog = new Dialog(Page_G.this);
                    ...
                    btnreff.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (nInfo[0] != null && nInfo[0].isConnected()) {
                                ...
                                Toast.makeText(Page_G.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    Toast.makeText(Page_G.this, "Internet Disconnected", Toast.LENGTH_LONG).show();
                    dialog.show();
                }
        ...
        addcmt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Page_G.this);
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);


                input1 = new EditText(Page_G.this);
...
//                        Toast.makeText(getApplicationContext(), "Text entered is " + input.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        addcmt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input2 = new EditText(Page_G.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input3 = new EditText(Page_G.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input5 = new EditText(Page_G.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input6 = new EditText(Page_G.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input4 = new EditText(Page_G.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        img_toast1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 snackbar = Snackbar
                        .make(coordinatorLayout, "Look out for: worn out tire, dent on vehicle body, cracked mirror, etc. Test safety critical functions on the spot if possible e.g. the brake, lights, reversing sensor, alarm, seat belt.", Snackbar.LENGTH_LONG);
        ...
        img_toast2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 snackbar = Snackbar
                        .make(coordinatorLayout, "Vehicle emergency kit: Extinguisher, First Aid Kit, High Visibility Vest, Safety Cones, Hazard Triangle, Spare Tire, Spill Absorbent Material & Trash Bag/ Spill Control Kit", Snackbar.LENGTH_LONG);
                View snackbarView = snackbar.getView();
                TextView textView = (TextView) snackbarView.findViewById(android.support.design.R.id.snackbar_text);
                textView.setMaxLines(6);
    ...
    public boolean validation() {
        ...
        try {
            ...
            try {
                ...
                if (get_rd1.length() != 0 && get_rd2.length() != 0 && get_rd3.length() != 0 && get_rd4.length() != 0&& get_rd5.length() != 0&& get_rd6.length() != 0 && get_rd_main.length() != 0) {
                    check_point = true;
                } else {
                    check_point = false;
                }
    ...
    private void submitres(final String saveid) {
        ...
        if (isInternetPresent) {
            ...
            VolleyDataRequester.withDefaultHttps( this )
                    .setUrl("https://rauditor.riflows.com/rauditor/Android/MSOT/page_7.php")
                    .setBody( params )
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(saveid.equalsIgnoreCase("save")){
                                    ...
                                    final AlertDialog.Builder builder = new AlertDialog.Builder(Page_G.this);
                                    builder.setMessage("Are You Sure Want to Save & Exit");
                                    builder.setPositiveButton("YES",
                                            new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int which) {

                                                    Intent intent=new Intent(Page_G.this, Category_Type_Activity.class);
                                                    startActivity(intent);
                                                }
                                            });
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            for (int i = 0; i < section_1.length; i++) {
                                                ...
                                                if (name.startsWith("h")) {
                                                    ...
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_H.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("i")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_I.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("j")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_J.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("k")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_K.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("l")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_L.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("m")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_M.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("n")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_N.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("o")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_G.this, Page_O.class);
                                                    startActivity(intent);
                                                    break;
    ...
    public void onBackPressed(){
                ...
                Intent intent = new Intent(Page_G.this, Page_F.class);
                startActivity(intent);
    ...
    private void get_LIST_Data(String key_id){
        ...
        String  url="https://rauditor.riflows.com/rauditor/Android/MSOT/get_page_7.php?main_id="+MSOT_Main.Main_ID ;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray_get.length(); i++) {
                                ...
                                String get_et6 = c.getString( "et6" );
                                String get_et7 = c.getString( "et7" );


                                String cv_cmt1 = c.getString( "cmt1" );
                                String cv_cmt2 = c.getString( "cmt2" );
                                String cv_cmt3 = c.getString( "cmt4" );
                                String cv_cmt4 = c.getString( "cmt5" );
                                String cv_cmt5 = c.getString( "cmt6" );
                                String cv_cmt6 = c.getString( "cmt7" );
                                ...
                                if(image_7.equalsIgnoreCase("")){
                                    ...
                                    byte[] decodedString_c5 = Base64.decode(image_7, Base64.DEFAULT);
                                    Bitmap decodedByte_c5 = BitmapFactory.decodeByteArray(decodedString_c5, 0, decodedString_c5.length);
                                    //   imageView1.setImageBitmap(decodedByte_c);
                                    Image_layout_Q7.setImageBitmap(Bitmap.createScaledBitmap(decodedByte_c5, 400, 400, false));
                                    Image_layout_Q7.setVisibility(View.VISIBLE);
...
//                            Toast.makeText( MSOT_Main.this, "HTTPS/GET, JsonRequest successfully.", Toast.LENGTH_SHORT ).show();
    ...
    public void insert_page_g(){
        ...
        cv_off_img.put(db.COMMANDS,get_input3);
        cv_off_img.put(db.QUESTION_ID,"G4");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
        ...
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input3);
        cv_off_img.put(db.QUESTION_ID,"G5");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
        ...
        cv_off_img.put(db.QUESTION_ID,"G6");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
