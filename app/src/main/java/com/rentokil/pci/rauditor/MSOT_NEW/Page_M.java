...
public class Page_M extends AppCompatActivity implements BaseSliderView.OnSliderClickListener  ,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHelper(Page_M.this);
        sd = db.getReadableDatabase();
        cv1 = new ContentValues();
        cv_off = new ContentValues();
        cv_off_img = new ContentValues();

        isInternetPresent = haveNetworkConnection(Page_M.this);
...
//      get_et2 = et2.getText().toString();
                    ...
                    if (validation()) {
                        ...
                        Toast.makeText(Page_M.this, "Please Fill All Details", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    ...
                    final Dialog dialog = new Dialog(Page_M.this);
                    ...
                    btnreff.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (nInfo[0] != null && nInfo[0].isConnected()) {
                                ...
                                Toast.makeText(Page_M.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    Toast.makeText(Page_M.this, "Internet Disconnected", Toast.LENGTH_LONG).show();
                    dialog.show();
                }
...
//
        ...
        pd = new SpotsDialog(Page_M.this, R.style.Custom);
        ...
        addcmt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Page_M.this);
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);


                input1 = new EditText(Page_M.this);
...
//                        Toast.makeText(getApplicationContext(), "Text entered is " + input.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        addcmt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input2 = new EditText(Page_M.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    public void onBackPressed(){
        ...
        Intent i = new Intent(Page_M.this,Page_L.class);
        startActivity(i);
    ...
    private void submitres(final String saveid) {
        ...
        if (isInternetPresent) {
            ...
            VolleyDataRequester.withDefaultHttps( this )
                    .setUrl("https://rauditor.riflows.com/rauditor/Android/MSOT/page_13.php")
                    .setBody( params )
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if(saveid.equalsIgnoreCase("save")){
                                        ...
                                        final AlertDialog.Builder builder = new AlertDialog.Builder(Page_M.this);
                                        builder.setMessage("Are You Sure Want to Save & Exit");
                                        builder.setPositiveButton("YES",
                                                new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int which) {

                                                        Intent intent=new Intent(Page_M.this, Category_Type_Activity.class);
                                                        startActivity(intent);
                                                    }
                                                });
                                        builder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Intent intent = new Intent(Page_M.this, Page_N.class);
                                                startActivity(intent);
    ...
    public void next_page_f(String page_name,int position){
        ...
        if(page_name.equalsIgnoreCase("INCIDENT REPORTING")){
            ...
            Intent intent = new Intent(Page_M.this, Page_A.class);
        ...
        if(page_name.equalsIgnoreCase("SINA CARD")){
            ...
            Intent intent = new Intent(Page_M.this, Page_B.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("ZERO TOLERANCE POLICY")){
            ...
            Intent intent = new Intent(Page_M.this, Page_C.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("SHE GOLDEN RULES")){
            ...
            Intent intent = new Intent(Page_M.this, Page_D.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("COMPLIANCE TO BASIC SAFETY RULES")){
            ...
            Intent intent = new Intent(Page_M.this, Page_K.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("SHE GOLDEN RULES TRAINING AT THE BRANCH")){
            ...
            Intent intent = new Intent(Page_M.this, Page_L.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("SRA IMPLEMENTATION AT THE BRANCH")){
            ...
            Intent intent = new Intent(Page_M.this, Page_M.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("DRIVING & MOTORBIKE RIDING SAFETY")){
            ...
            Intent intent = new Intent(Page_M.this, Page_O.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("5.WORKING AT HEIGHT")){
            ...
            Intent intent = new Intent(Page_M.this, Page_E.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("6.SLIP, TRIP & FALL, MOVING VEHICLE & OTHER RISKS")){
            ...
            Intent intent = new Intent(Page_M.this, Page_F.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("7.DRIVING & PEDESTRIAN SAFETY")){
            ...
            Intent intent = new Intent(Page_M.this, Page_G.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("8.ELECTRICAL SAFETY")){
            ...
            Intent intent = new Intent(Page_M.this, Page_H.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("9.FUMIGATION SAFETY")){
            ...
            Intent intent = new Intent(Page_M.this, Page_I.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
        ...
        if(page_name.equalsIgnoreCase("10.EMPLOYEE INDUCTION & CONSULTATION")){
            ...
            Intent intent = new Intent(Page_M.this, Page_J.class);
            intent.putExtra("page_name",""+position);
            startActivity(intent);
...
//
    ...
    private void get_LIST_Data(String key_id){
        ...
        String  url="https://rauditor.riflows.com/rauditor/Android/MSOT/get_page_13.php?main_id="+MSOT_Main.Main_ID ;
