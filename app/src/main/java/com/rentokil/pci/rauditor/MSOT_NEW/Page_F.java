...
public class Page_F extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, View.OnClickListener {


    SliderLayout mDemoSlider;

    LinearLayout get_layout1,get_layout2;
    ...
    RadioGroup rd1,rd2,rd3,rd4,rd5,rd6;
    String Main_ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHelper(Page_F.this);
        ...
        pd = new SpotsDialog(Page_F.this, R.style.Custom);
        ...
        isInternetPresent = haveNetworkConnection(Page_F.this);
...
//                    get_et2 = et2.getText().toString();
                    ...
                    if (validation()) {
                        ...
                        Toast.makeText(Page_F.this, "Please Fill All Details", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    pd.dismiss();
                    final Dialog dialog = new Dialog(Page_F.this);
                    ...
                    btnreff.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (nInfo[0] != null && nInfo[0].isConnected()) {
                                ...
                                Toast.makeText(Page_F.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    Toast.makeText(Page_F.this, "Internet Disconnected", Toast.LENGTH_LONG).show();
                    dialog.show();
                }
...
//
        ...
        addcmt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Page_F.this);
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);


                input1 = new EditText(Page_F.this);
...
//                        Toast.makeText(getApplicationContext(), "Text entered is " + input.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        addcmt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input2 = new EditText(Page_F.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input3 = new EditText(Page_F.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input5 = new EditText(Page_F.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input6 = new EditText(Page_F.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        addcmt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Actions/Comments");
                builder.setIcon(R.drawable.commenticon);
                input4 = new EditText(Page_F.this);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        img_toast1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 snackbar = Snackbar
                        .make(coordinatorLayout, "Avoid installing on slope, near open drain, or at area with narrow access or without a proper access path", Snackbar.LENGTH_LONG);
        ...
        img_toast2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 snackbar = Snackbar
                        .make(coordinatorLayout, "Examples: lnstall away from moving vehicles at carpark/ loading bay, or forklift at warehouse, away from opening/ closing door, away from window which maybe an overhead hazard, away from electrical cable and electrical panel", Snackbar.LENGTH_LONG);
                View snackbarView = snackbar.getView();
                TextView textView = (TextView) snackbarView.findViewById(android.support.design.R.id.snackbar_text);
                textView.setMaxLines(6);
                snackbar.setDuration(10000);
        ...
        img_toast3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 snackbar = Snackbar
                        .make(coordinatorLayout, "Risk Areas: checking bait box at carpark, spraying at loading bay, fogging outdoor, servicing insect light trap or changing mat in warehouse with forklift", Snackbar.LENGTH_LONG);
                View snackbarView = snackbar.getView();
                TextView textView = (TextView) snackbarView.findViewById(android.support.design.R.id.snackbar_text);
                textView.setMaxLines(6);
...
//        });
    ...
    public boolean validation() {
        ...
        try {
            ...
            if(get_rd4.length()!=0&&get_rd5.length()!=0&&get_rd6.length()!=0) {
                try {
                    if (get_question_int("f") == 0) {
                        check_point = true;
    ...
    private void submitres(final String saveid) {
        ...
        if (isInternetPresent) {
            ...
            VolleyDataRequester.withDefaultHttps( this )
                    .setUrl("https://rauditor.riflows.com/rauditor/Android/MSOT/page_6.php")
                    .setBody( params )
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(saveid.equalsIgnoreCase("save")){
                                    ...
                                    final AlertDialog.Builder builder = new AlertDialog.Builder(Page_F.this);
                                    builder.setMessage("Are You Sure Want to Save & Exit");
                                    builder.setPositiveButton("YES",
                                            new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int which) {

                                                    Intent intent=new Intent(Page_F.this, Category_Type_Activity.class);
                                                    startActivity(intent);
                                                }
                                            });
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            for (int i = 0; i < section_1.length; i++) {
                                                ...
                                                if (name.startsWith("g")) {
                                                    pd.dismiss();
                                                    Log.e("DDDDHHHS", "JJJJJ");
                                                    Intent intent = new Intent(Page_F.this, Page_G.class);
                                                    startActivity(intent);
                                                    break;
                                                } else if (name.startsWith("h")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_H.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("i")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_I.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("j")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_J.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("k")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_K.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("l")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_L.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("m")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_M.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("n")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_N.class);
                                                    startActivity(intent);
                                                    break;

                                                } else if (name.startsWith("o")) {
                                                    pd.dismiss();
                                                    Intent intent = new Intent(Page_F.this, Page_O.class);
                                                    startActivity(intent);
                                                    break;
...
//
    ...
    public void onBackPressed(){
                ...
                Intent intent = new Intent(Page_F.this, Page_E.class);
                startActivity(intent);
    ...
    private void get_LIST_Data(String key_id){
        ...
        String  url="https://rauditor.riflows.com/rauditor/Android/MSOT/get_page_6.php?main_id="+MSOT_Main.Main_ID ;
...
//                            Toast.makeText( MSOT_Main.this, "HTTPS/GET, JsonRequest successfully.", Toast.LENGTH_SHORT ).show();
 ...
 cv_off_img.clear();
        ...
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input2);
        cv_off_img.put(db.QUESTION_ID,"F2");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
 cv_off_img.clear();
        cv_off_img.put(db.MAIN_ID,Main_ID);
        cv_off_img.put(db.PAGE_ID,"6");
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input2);
        cv_off_img.put(db.QUESTION_ID,"F4");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
 cv_off_img.clear();
        cv_off_img.put(db.MAIN_ID,Main_ID);
        cv_off_img.put(db.PAGE_ID,"6");
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input2);
        cv_off_img.put(db.QUESTION_ID,"F5");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
cv_off_img.clear();
        cv_off_img.put(db.MAIN_ID,Main_ID);
        cv_off_img.put(db.PAGE_ID,"6");
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input2);
        cv_off_img.put(db.QUESTION_ID,"F6");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
        ...
        cv_off_img.put(db.IMAGE_1,bitmapget2);
        cv_off_img.put(db.COMMANDS,get_input2);
        cv_off_img.put(db.QUESTION_ID,"F7");
        sd.insert(db.MSOT_IMAGE_TB,null,cv_off_img);
